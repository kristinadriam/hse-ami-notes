...
%\numberwithin{figure}{section} % Number figures within sections (i.e. 
1.1, 1.2, 2.1, 2.2 instead of 1, 2, 3, 4)
%\numberwithin{table}{section} % Number tables within sections (i.e. 1.1, 
...
\usepackage[colorlinks, urlcolor = Blue, filecolor = Blue,citecolor = 
Blue, linkcolor = Blue]{hyperref}
